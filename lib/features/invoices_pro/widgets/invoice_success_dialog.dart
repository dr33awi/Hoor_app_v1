...
class _InvoiceSuccessDialogState extends State<InvoiceSuccessDialog> {
        ...
        child: Column(
          ...
          children: [
            ...
            _SizeOption(
              ...
              onTap: () => Navigator.pop(ctx, InvoicePrintSize.thermal58mm),
            ),
            SizedBox(height: 8.h),
            _SizeOption(
              ...
              onTap: () => Navigator.pop(ctx, InvoicePrintSize.thermal80mm),
            ),
            SizedBox(height: 8.h),
            _SizeOption(
              ...
              onTap: () => Navigator.pop(ctx, InvoicePrintSize.a4),
            ),
            SizedBox(height: 16.h),
          ],
        ),
  ...
  Future<void> _print() async {
    ...
    await _handleAction('print', () async {
      final baseOptions = await getIt<PrintSettingsService>().getPrintOptions();
      final options = baseOptions.copyWith(size: selectedSize);
  ...
  Future<void> _share() async {
    ...
    await _handleAction('share', () async {
      final baseOptions = await getIt<PrintSettingsService>().getPrintOptions();
      final options = baseOptions.copyWith(size: selectedSize);
  ...
  Future<void> _preview() async {
    ...
    await _handleAction('preview', () async {
      final baseOptions = await getIt<PrintSettingsService>().getPrintOptions();
      final options = baseOptions.copyWith(size: selectedSize);
