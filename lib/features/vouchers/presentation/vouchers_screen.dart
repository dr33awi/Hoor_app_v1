...
class _VouchersScreenState extends ConsumerState<VouchersScreen>
  ...
  Future<void> _handleExport(String exportType) async {
    try {
      ...
      switch (exportType) {
        case 'receipt':
          vouchers = await _voucherRepo.getVouchersByType(VoucherType.receipt);
          type = 'receipt';
          fileName = 'receipt_vouchers';
          break;
        case 'payment':
          vouchers = await _voucherRepo.getVouchersByType(VoucherType.payment);
          type = 'payment';
          fileName = 'payment_vouchers';
          break;
        case 'expense':
          vouchers = await _voucherRepo.getVouchersByType(VoucherType.expense);
          type = 'expense';
          fileName = 'expense_vouchers';
          break;
        default:
          vouchers = await _voucherRepo.getAllVouchers();
          type = null;
          fileName = 'all_vouchers';
      }
