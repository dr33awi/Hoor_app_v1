...
// New Screens
import '../../features/suppliers_pro/supplier_form_screen_pro.dart';
import '../../features/suppliers_pro/supplier_details_screen_pro.dart';
  ...
  return GoRouter(
    ...
    routes: [
      ...
      GoRoute(
        path: '/sales',
        name: 'sales',
        redirect: (context, state) => '/sales/add',
      ),
      GoRoute(
        path: '/sales/add',
        name: 'sales-add',
      ...
      GoRoute(
        ...
        pageBuilder: (context, state) => _buildSlideTransition(
          state,
          InvoicePreviewScreenPro(invoiceId: state.pathParameters['id']!),
        ),
      ),
      ...
      GoRoute(
        ...
        routes: [
          ...
          GoRoute(
            ...
            pageBuilder: (context, state) => _buildSlideTransition(
              state,
              CustomerDetailsScreenPro(customerId: state.pathParameters['id']!),
            ),
          ),
        ],
      ),
      ...
      GoRoute(
        ...
        routes: [
          ...
          GoRoute(
            ...
            pageBuilder: (context, state) => _buildSlideUpTransition(
              state,
              SupplierFormScreenPro(supplierId: state.pathParameters['id']),
            ),
          ),
          GoRoute(
            path: ':id',
            ...
            pageBuilder: (context, state) => _buildSlideTransition(
              state,
              SupplierDetailsScreenPro(supplierId: state.pathParameters['id']!),
            ),
          ),
        ],
      ),
      ...
      GoRoute(
        ...
        routes: [
          ...
          GoRoute(
            ...
            name: 'receipt-voucher-edit',
            pageBuilder: (context, state) => _buildSlideUpTransition(
              state,
              VoucherFormScreenPro(
                  type: 'receipt', voucherId: state.pathParameters['id']),
            ),
          ),
          GoRoute(
            path: 'payment/add',
          ...
          GoRoute(
            ...
            pageBuilder: (context, state) => _buildSlideUpTransition(
              state,
              VoucherFormScreenPro(
                  type: 'payment', voucherId: state.pathParameters['id']),
            ),
          ),
          GoRoute(
            path: 'expense/add',
            name: 'expense-voucher-add',
            pageBuilder: (context, state) => _buildSlideUpTransition(
              state,
              const VoucherFormScreenPro(type: 'expense'),
            ),
          ),
          GoRoute(
            ...
            pageBuilder: (context, state) => _buildSlideUpTransition(
              state,
              VoucherFormScreenPro(
                  type: 'expense', voucherId: state.pathParameters['id']),
            ),
          ),
          GoRoute(
            path: ':id',
      ...
      GoRoute(
        ...
        routes: [
          ...
          GoRoute(
            ...
            pageBuilder: (context, state) => _buildSlideTransition(
              state,
              const ReportDetailScreenPro(reportType: 'payables'),
            ),
          ),
          GoRoute(
            path: 'inventory',
            ...
            pageBuilder: (context, state) => _buildSlideTransition(
              state,
              const ReportDetailScreenPro(reportType: 'inventory'),
            ),
          ),
        ],
      ),
